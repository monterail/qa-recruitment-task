...
User.create(email: "qa7@monterail.com", birthday_month: 6, birthday_day: 9, name: "Blue John",sso_id: "qa7ssoid" , password: "123456")
User.create(email: "qa8@monterail.com", birthday_month: 6, birthday_day: 9, name: "Purple John",sso_id: "qa8ssoid" , password: "123456")
