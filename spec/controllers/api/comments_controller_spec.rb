...
describe Api::CommentsController do
  ...
  describe "post #create" do
    it "new comment has owner" do
      post :create, proposition_id: proposition.id, comment: comment.as_json
  ...
  describe "put #update" do
    context "if owner is current_user" do
      it "updates comment" do
        ...
        put :update, proposition_id: comment.proposition_id, id: comment.id, comment: comment.as_json
